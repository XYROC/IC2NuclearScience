...
import nuclearscience.util.NuclearScienceRecipies;

@Mod(modid = NuclearScience.name, name = NuclearScience.name, version = "alpha0.1", dependencies = "required-after:IC2@2.2.828")
public class NuclearScience {
	...
	public void init(FMLInitializationEvent event) {
		...
		NuclearScienceRecipies.registerRecipies();
